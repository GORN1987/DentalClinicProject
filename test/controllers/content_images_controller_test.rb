...
class ContentImagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create content_image" do
    assert_difference('ContentImage.count') do
      post content_images_url, params: { content_image: { alternative_text: @content_image.alternative_text, file_name: @content_image.file_name, optional_caption: @content_image.optional_caption } }
    end
  ...
  test "should update content_image" do
    patch content_image_url(@content_image), params: { content_image: { alternative_text: @content_image.alternative_text, file_name: @content_image.file_name, optional_caption: @content_image.optional_caption } }
